...
const CLINIC = {
  ...
  address: "House 84, Along Kantanta Street, Nkana East, Kitwe, Zambia",
  hours: [
...
const SERVICES = [
  ...
  { id: "braces", name: "Braces", icon: "braces", desc: "Orthodontic treatment to gradually straighten and align your teeth.", image: "assets/img/services/braces.jpg", ratio: "736/981" },
  ...
  { id: "extractions", name: "Extractions", icon: "extraction", desc: "Safe removal of a damaged or problem tooth, carried out with care.", image: "assets/img/services/extractions.jpg", ratio: "735/490" },
  { id: "whitening", name: "Teeth Whitening", icon: "whitening", desc: "Professional whitening to brighten your smile safely and evenly.", image: "assets/img/services/whitening.jpg", ratio: "563/258" },
  { id: "xrays", name: "Digital X-Ray", icon: "xray", desc: "Fast, clear digital imaging to help diagnose and plan your care accurately.", image: "assets/img/services/xrays.jpg", ratio: "635/435" },
];
