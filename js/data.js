...
const SERVICES = [
  ...
  { id: "filling", name: "Tooth Fillings", icon: "filling", desc: "Repairing cavities and minor damage to restore your tooth's shape and function.", image: "https://images.unsplash.com/photo-1598256989800-fe5f95da9787?w=600&q=80&auto=format&fit=crop" },
  { id: "rootcanal", name: "Root Canal Treatment", icon: "root", desc: "Treating infection inside the tooth to relieve pain and preserve your natural tooth.", image: "https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?w=600&q=80&auto=format&fit=crop" },
  { id: "cleaning", name: "Teeth Cleaning", icon: "cleaning", desc: "Routine professional cleaning to remove plaque, tartar and support healthy gums.", image: "https://images.unsplash.com/photo-1606811856475-5e6fcdc6e509?w=600&q=80&auto=format&fit=crop" },
  ...
  { id: "crowns", name: "Crowns and Bridges", icon: "crown", desc: "Custom restorations to repair a damaged tooth or replace a missing one.", image: "https://images.unsplash.com/photo-1667133295352-ef4c83620e8e?w=600&q=80&auto=format&fit=crop" },
  { id: "implants", name: "Implants", icon: "implant", desc: "Implant placement to replace missing teeth with a secure, natural-looking result.", image: "https://images.unsplash.com/photo-1593022356769-11f762e25ed9?w=600&q=80&auto=format&fit=crop" },
  { id: "dentures", name: "Dentures", icon: "dentures", desc: "Removable replacement teeth, fitted to restore your bite and your smile.", image: "https://images.unsplash.com/photo-1468493858157-0da44aaf1d13?w=600&q=80&auto=format&fit=crop" },
  { id: "braces", name: "Braces", icon: "braces", desc: "Orthodontic treatment to gradually straighten and align your teeth.", image: "https://images.unsplash.com/photo-1564420228450-d9a5bc8d6565?w=600&q=80&auto=format&fit=crop" },
  { id: "veneers", name: "Veneers", icon: "veneers", desc: "Thin custom shells bonded to the front of your teeth to refine your smile.", image: "https://images.unsplash.com/photo-1562337404-3044c84ac061?w=600&q=80&auto=format&fit=crop" },
